            ...
            <div className="container mx-auto min-h-[800px] mb-14">
                ...
                <div className="flex flex-col items-start gap-8 lg:flex-row">
                    <div className="max-w-[768px]">
                        <div className="mb-8">
                            <img src={property.imageLg} alt="large-pics" />
                        </div>
                    ...
                    <div className="flex-1 w-full mb-8 bg-white border border-gray-300 rounded-lg px-6 py-8">
                        <div className="flex items-center gap-x-4 mb-8">
                            <div className="w-20 h-20 p-1 border border-gray-300 rounded-full">
                                <img src={property.agent.image} alt="large-pics" />
                            </div>
                            <div>
                        ...
                        <form className="flex flex-col gap-y-4">
                            ...
                            <div className="flex gap-x-2">
                                ...
                                <button className="border border-blue-700 text-blue-700 hover:border-purple-600 hover:text-purple-600 rounded p-4 text-sm w-full transition" disabled>
                                    Call
                                </button>
                            </div>
                        </form>
